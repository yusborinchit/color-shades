...
export default function Home() {
  return (
    <div className="relative mx-auto max-w-screen-md px-8">
      ...
      <main className="py-4">
        <section className="pt-24">
          <div className="absolute -left-24 top-5 -z-10 size-80 rounded-full bg-primary-300 opacity-30" />
          <div className="absolute -right-10 top-56 -z-10 size-48 rounded-full bg-primary-800 opacity-30" />
      ...
      <footer className="mt-16 flex flex-col items-center justify-between py-4 text-neutral-500 sm:flex-row">
        <p className="">
